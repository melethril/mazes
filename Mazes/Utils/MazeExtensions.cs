...
namespace Mazes
{
    public static class MazeExtensions
    {
        ...
        public static void RenderAsPng(this Maze maze, string fullPath, Dimensions imageSize, MazeStyles? styles = null)
        {
            var renderer = new ImageRenderer(styles ?? new MazeStyles(), new RendererRegistry());

            using SKSurface surface = renderer.Render(maze, imageSize);
